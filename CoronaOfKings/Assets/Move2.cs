...
public class Move2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            {
                Debug.Log(npc1);
                npc1Obj.GetComponent<Npc1S2>().ExitRightAnswer();
                xd = true;
            }
            ...
            if (npc2 == 2)
            {
                ...
                npc2Obj.GetComponent<Npc2S2>().ExitRightAnswer();
            }

            if (npc3 == 3)
            {
                Debug.Log(npc3);
                npc3Obj.GetComponent<Npc3S2>().ExitRightAnswer();
            }
            if ((npc1 == 0 && npc2 == 0 && npc3 == 3) ||
                (npc1 == 0 && npc2 == 2 && npc3 == 0) ||
